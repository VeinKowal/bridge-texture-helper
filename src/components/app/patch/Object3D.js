...
Object3D.prototype.on = function (type, callback) {
  PointerEvents.addEventListenerByObject3D(this, type, callback);
};

Object3D.prototype.off = function (type, callback) {
  PointerEvents.removeEventListenerByObject3D(this, type, callback);
};
